import logo3hermanos from './navbar/logo.webp'
import selvaImg from './products/selva.webp'
import shippingSvg from './icons/local_shipping.svg'
...
export const shippingIcon = shippingSvg
